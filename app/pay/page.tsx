      ...
      <main className="mx-auto max-w-4xl px-6 py-10 lg:px-8">
        <div className="space-y-8 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          <div className="space-y-4">
            <p className="text-sm uppercase tracking-[0.24em] text-brand-700">Secure payment</p>
            <h1 className="text-4xl font-semibold text-slate-950">Pay Now</h1>
          ...
          <div className="grid gap-6 rounded-3xl border border-slate-200 bg-slate-50 p-6 text-slate-700 sm:grid-cols-2">
            <div>
              <h2 className="text-base font-semibold text-slate-950">Service</h2>
              <p className="mt-2">Mobile Ink Fingerprinting</p>
            </div>
            <div>
              <h2 className="text-base font-semibold text-slate-950">Amount</h2>
              <p className="mt-2 text-lg font-semibold text-slate-950">$125.00</p>
            </div>
          </div>
