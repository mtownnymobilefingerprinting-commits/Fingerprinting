...
export const calendlyLinks = {
  ...
  fd258: calendlyBase,
  fbiCard: calendlyBase,
  immigration: calendlyBase,
  adoption: calendlyBase,
  personalRecordReview: calendlyBase,
  employment: calendlyBase,
  nursingLicense: calendlyBase,
  teacherCertification: calendlyBase,
  securityGuard: calendlyBase,
  realEstateLicense: calendlyBase,
  finra: calendlyBase,
  corporate: calendlyBase,
  onSiteBusiness: calendlyBase,
  group: calendlyBase,
