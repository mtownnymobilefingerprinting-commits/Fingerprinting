export type ServiceConfig = {
  ...
  paymentWorkflow: "payFirst" | "bookFirst";
};
...
export const services: ServiceConfig[] = [
  {
    ...
    description:
      "On-site ink fingerprinting with HD finger capture for business, legal, and healthcare appointments.",
    idealCustomer: "Businesses, legal teams, and individuals who need fast, mobile ink fingerprinting.",
    price: "$125 per person within 20 miles of Middletown, NY",
    seoTitle: "Mobile Ink Fingerprinting in Middletown NY",
    seoDescription:
      "Mobile ink fingerprinting service in Middletown and Orange County with fast appointment scheduling and on-site service.",
    appointmentId: "mobileInk",
    paymentWorkflow: "bookFirst"
  },
  {
    id: "fd258",
